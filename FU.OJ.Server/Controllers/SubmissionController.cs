...
namespace FU.OJ.Server.Controllers
{
    ...
    public class SubmissionController : BaseController
    {
        ...
        public async Task<IActionResult> SubmitCode(
            ...
            [FromQuery] bool base64Encoded = false,
        ...
        public async Task<IActionResult> GetAllSubmissions([FromQuery] Paging query)
        {
            try
            {
                ...
                var (submissions, totalPages) = await _submissionService.GetAllSubmissionsAsync(
                    query
                );
        ...
        public async Task<IActionResult> GetAllSubmissionsBelongsUser(
        ...
        )
        {
            ...
            {
                // Gọi dịch vụ để lấy danh sách submissions và tổng số trang
                var (submissions, totalPages) =
                    await _submissionService.GetAllSubmissionsBelongsUserAsync(query, username);
