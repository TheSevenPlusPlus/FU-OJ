...
namespace FU.OJ.Server.Infra.DBInitializer
{
    ...
    public class DbInitializer : IDbInitializer
    {
        ...
        public void Initialize()
        {
            ...
            {
                _roleManager
                    .CreateAsync(new IdentityRole(RoleStatic.RoleAdmin))
                    .GetAwaiter()
                    .GetResult();
                _roleManager
                    .CreateAsync(new IdentityRole(RoleStatic.RoleManager))
                    .GetAwaiter()
                    .GetResult();
                _roleManager
                    .CreateAsync(new IdentityRole(RoleStatic.RoleUser))
                    .GetAwaiter()
                    .GetResult();
                ...
                _userManager
                    .AddToRoleAsync(adminUser, RoleStatic.RoleAdmin)
                    .GetAwaiter()
                    .GetResult();
            }
