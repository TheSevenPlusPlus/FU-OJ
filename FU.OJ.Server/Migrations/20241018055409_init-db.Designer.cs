...
namespace FU.OJ.Server.Migrations
{
    ...
    [Migration("20241018055409_init-db")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FU.OJ.Server.Infra.Models.Contest", b =>
                {
                    ...
                    b.Property<string>("OrganizationId")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasComment("ID người tổ chức contest");

                    b.Property<string>("OrganizationName")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasComment("Tên Người tổ chức contest");
            ...
            modelBuilder.Entity("FU.OJ.Server.Infra.Models.ContestRank", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("ContestParticipantName")
                        .HasColumnType("text");

                    b.Property<string>("ContestProblemCode")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.ToTable("contestRanks");
                });

            modelBuilder.Entity("FU.OJ.Server.Infra.Models.ExampleInputOutput", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("FU.OJ.Server.Infra.Models.ContestRank", b =>
                {
                    b.HasOne("FU.OJ.Server.Infra.Models.ContestParticipant", "Participant")
                        .WithMany("ContestRank")
                        .HasForeignKey("ContestParticipantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FU.OJ.Server.Infra.Models.ContestProblem", "Problem")
                        .WithMany("ContestRank")
