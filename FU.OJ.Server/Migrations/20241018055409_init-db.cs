    ...
    public partial class initdb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExampleInputOutputs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExampleInputOutputs_Problems_ProblemId",
                        column: x => x.ProblemId,
                        principalTable: "Problems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "text", nullable: true),
                    ContestCode = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "text", nullable: false),
                    ContestProblemId = table.Column<string>(type: "text", nullable: false),
                    ContestProblemCode = table.Column<string>(type: "text", nullable: false),
                    ContestParticipantId = table.Column<string>(type: "text", nullable: false),
                    ContestParticipantName = table.Column<string>(type: "text", nullable: true),
                    PassedTestCount = table.Column<int>(type: "integer", nullable: false),
                    Point = table.Column<double>(type: "double precision", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_contestRanks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_contestRanks_ContestParticipants_ContestParticipantId",
                        column: x => x.ContestParticipantId,
                        principalTable: "ContestParticipants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_contestRanks_ContestProblems_ContestProblemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_contestRanks_ContestParticipantId",
                table: "contestRanks",
                column: "ContestParticipantId");

            migrationBuilder.CreateIndex(
                name: "IX_contestRanks_ContestProblemId",
                table: "contestRanks",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExampleInputOutputs_ProblemId",
                table: "ExampleInputOutputs",
                column: "ProblemId");
