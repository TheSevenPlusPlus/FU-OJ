...
namespace FU.OJ.Server.Service
{
    public interface IBlogCommentService
    {
        ...
        Task<(List<BlogCommentResponse> comments, int totalPages)> GetCommentsByBlogIdAsync(
            string blogId,
            Paging query
        ); // New method for paginated comments by blog ID
    ...
    public class BlogCommentService : IBlogCommentService
    {
        ...
        public async Task<(
            ...
            int totalPages
        )> GetCommentsByBlogIdAsync(string blogId, Paging query)
        {
        ...
        public async Task<BlogComment?> GetLastCommentByUserAsync(string username, string blogId)
        {
            ...
            return await _context
                .BlogComments.Where(c => c.UserId == user.Id && c.BlogId == blogId)
