...
namespace FU.OJ.Server.Service
{
    ...
    public class ProblemService : IProblemService
    {
        ...
        {
            return await _context.Problems.AsNoTracking().FirstOrDefaultAsync(p => p.Code == code);
        }

        public async Task<Problem?> GetByIdAsync(string id)
        {
            return await _context.Problems.AsNoTracking().FirstOrDefaultAsync(p => p.Id == id);
        }
