            ...
            <div className="flex flex-col min-h-screen bg-white">
                ...
                <main className="flex-grow">
                    <Routes>
                        ...
                        {/*<Route path="/change-password" element={<ProfileEdit />} />*/}
                        {/* Problem */}
                        ...
                        {/*Contests*/}
                        <Route path="/contests" element={<ComingSoon targetDate={new Date("2024-10-07T00:00:00")} />} />
                        ...
                        <Route path="/manager/users/update/:userName" element={<UpdateUser />} />
                        <Route path="/manager/blogs" element={<ComingSoon targetDate={new Date("2024-10-07T00:00:00")} />} />
