      ...
      <section className="bg-black text-white">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-3 max-w-md mx-auto text-base sm:text-lg md:mt-5 md:text-xl text-gray-300">
            Challenge yourself with coding problems, compete in contests, and
        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:py-16 sm:px-6 lg:px-8 lg:py-20">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="mt-3 text-xl text-gray-300 sm:mt-4">
              Join our growing community of problem solvers and competitive
              programmers.
            </p>
          </div>
          <dl className="mt-10 text-center sm:max-w-3xl sm:mx-auto sm:grid sm:grid-cols-3 sm:gap-8">
            {stats.map((item, index) => (
              <div key={index} className="flex flex-col">
                ...
                <dd className="order-1 text-5xl font-extrabold">{item.stat}</dd>
              </div>
            ))}
          </dl>
        </div>
