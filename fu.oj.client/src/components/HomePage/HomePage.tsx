...
const blogPosts = [
    {
        ...
        description:
            "Learn essential techniques for solving complex algorithmic problems using dynamic programming.",
        author: "Jane Smith",
        date: "Mar 16, 2023",
        readTime: "6 min read",
    },
    {
        ...
        description:
            "Explore advanced graph algorithms and their applications in solving real-world problems.",
        author: "John Doe",
        date: "Mar 20, 2023",
        readTime: "8 min read",
    },
    {
        title: "Optimizing Time Complexity",
        description:
            "Discover strategies to improve the time complexity of your algorithms and boost performance.",
            ...
            <section className="bg-black text-white">
                <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="mt-3 max-w-md mx-auto text-base sm:text-lg md:mt-5 md:text-xl text-gray-300">
                        Challenge yourself with coding problems, compete in
                        contests, and improve your algorithmic skills.
                    </p>
                ...
                <div className="max-w-7xl mx-auto py-12 px-4 sm:py-16 sm:px-6 lg:px-8 lg:py-20">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <p className="mt-3 text-xl text-gray-300 sm:mt-4">
                            Join our growing community of problem solvers and
                        ...
                        {blogPosts.map((post, index) => (
                            <Card key={index}>
                                <img
                                    ...
                                    src={`https://source.unsplash.com/random/800x600?coding&sig=${index}`}
                                    alt=""
                                />
                                <CardHeader>
            ...
            <section className="bg-black">
                <div className="max-w-2xl mx-auto text-center py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
                    ...
                    <p className="mt-4 text-lg leading-6 text-gray-300">
                        Join thousands of developers who are improving their
                        coding skills every day.
                    </p>
