        ...
        <div className="container mx-auto p-4">
            ...
            <div className="flex justify-between items-center mb-4">
                <Link to="/manager/contests/create">
                    <Button>
                        <Plus className="mr-2 h-4 w-4" /> Add New Contest
                    </Button>
                </Link>
            ...
            <Table className="border border-gray-300">
                <TableHeader>
                    <TableRow className="border-b border-gray-300 bg-black">
                        ...
                        <TableHead className="border border-gray-300 text-white font-bold">Rules</TableHead>
                ...
                <TableBody>
                    {contests.map((contest) => (
                        <TableRow key={contest.id} className="border-b border-gray-300 hover:bg-gray-100 transition duration-200">
                            ...
                            <TableCell className="border border-gray-300">{contest.rules}</TableCell>
                            <TableCell>
                                <TooltipProvider>
                                    <Tooltip>
