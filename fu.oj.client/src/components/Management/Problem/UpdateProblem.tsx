                        ...
                        <CardContent className="p-4">
                            {testCaseFile ? (
                                <div className="flex items-center justify-between">
                                    <span className="text-sm text-gray-600">{testCaseFile.name}</span>
                                    <Button
                                        type="button"
                                        variant="ghost"
                                        size="sm"
                                ...
                                <label htmlFor="testCase" className="flex flex-col items-center justify-center cursor-pointer">
                                    <Upload className="h-8 w-8 text-gray-400" />
                                    <span className="mt-2 text-sm text-gray-500">Click to upload new test case file</span>
                                    <Input
                                        id="testCase"
                                        name="testCase"
                                        type="file"
