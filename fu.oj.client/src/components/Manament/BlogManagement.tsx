...
const fetchBlogs = async () => {
    // Simulating API call
    return [
        { id: 1, title: "Introduction to React", author: "John Doe", status: "Published", content: "React is a popular JavaScript library..." },
        { id: 2, title: "Advanced TypeScript Tips", author: "Jane Smith", status: "Draft", content: "TypeScript offers many advanced features..." },
        { id: 3, title: "CSS Grid Layout", author: "Bob Johnson", status: "Published", content: "CSS Grid is a powerful layout system..." },
    ];
};

const addBlog = async (blog: { title: string; author: string; status: string; content: string }) => {
    // Simulating API call
    console.log("Adding blog:", blog);
    return { id: Date.now(), ...blog };
};

const updateBlog = async (id: number, blog: { title: string; author: string; status: string; content: string }) => {
    // Simulating API call
            ...
            <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                ...
                <DialogContent className="sm:max-w-[600px]">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <Button type="submit">{editingBlog ? "Update" : "Add"} Blog Post</Button>
                    </form>
                </DialogContent>
            </Dialog>
                        ...
                        <TableRow key={blog.id}>
                            ...
                            <TableCell>
                                <TooltipProvider>
                                    ...
                                    <Tooltip>
                                        <TooltipTrigger asChild>
                                            <Button variant="outline" size="sm" className="mr-2" onClick={() => handleDelete(blog.id)}>
                                    ...
                                    <Tooltip>
                                        <DialogTrigger asChild>
                                            <Button variant="outline" size="sm" onClick={() => setPreviewBlog(blog)}>
