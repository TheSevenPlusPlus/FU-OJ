...
import { Facebook, Github, MapPin, Mail, Phone, School, User, Briefcase, Calendar } from 'lucide-react';
                ...
                <CardHeader>
                    <div className="flex flex-col md:flex-row items-center md:items-start space-y-4 md:space-y-0 md:space-x-4">
                        <Avatar className="w-24 h-24">
                            <AvatarImage src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRD3OGZfe1nXAqGVpizYHrprvILILEvv1AyEA&s" alt={profile.fullname} />
